...
def main():
    ...
    parser.add_argument('--hand_type',default="right", choices=['left', 'right'], required=True, help='指定左手或右手')
    parser.add_argument('--hand_joint',default="L10", required=True, help='指定LinkerHand型号')
    parser.add_argument('--can', default="PCAN_USBBUS1", help='指定CAN编号')
