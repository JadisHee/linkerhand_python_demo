...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        if self.hand_joint == "L7":
            ...
            self.set_speed(speed=[100,100,100,100,100,100,100,100,100,100])
            self.set_torque()
            self.touch_type = self.api.get_touch_type()
            # if self.touch_type == 2:
            #     self._init_normal_force_plot(num_lines=6) # 法向压力波形图
    ...
    def set_torque(self, torque=[255,255,255,255,255,255,255,255,255,255]):
        ColorMsg(msg=f"设置力矩:{torque}", color="green")
